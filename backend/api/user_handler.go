...
func setupCORS(router *gin.Engine) {
	...
	config.AllowOrigins = []string{"http://localhost:3000", "http://localhost:8080", "http://localhost:5173", "https://duty57.github.io", "https://duty57.github.io/chord_viewer", "https://chord-viewer.onrender.com"}
